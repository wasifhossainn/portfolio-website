    ...
    <React.Fragment>
      ...
      <div className="content" id="About">
        ...
        <p className="about-section-2">
          I'm a passionate and a hardworking individual who has had experience
          working as a full-time front-end developer at Stomble.
          <br />
          This involved me to develop skills of web development as I used
          ReactJS Framework to create a video platform.
        </p>

        <p className="about-section-3">
          In the future, I believe that software engineering gives me the
          opportunity and provides me exposure to tools and skills
          <br /> which can be implemented in real-world problems to produce
          premium quality applications and solutions. These solutions can
          <br /> solve problems in an innovative way and enhance interactions
          that are made between the user and their devices.
        </p>
